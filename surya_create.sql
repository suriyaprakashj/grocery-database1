...
-- Last modification date: 2021-11-20 07:31:40.28
...
-- Reference: SlaesTable_Customer_Table (table: SlaesTable)
ALTER TABLE SlaesTable ADD CONSTRAINT SlaesTable_Customer_Table FOREIGN KEY SlaesTable_Customer_Table (Customer_Table_customerID)
    REFERENCES Customer_Table (customerID);

-- Reference: SlaesTable_SalesDetails (table: SlaesTable)
ALTER TABLE SlaesTable ADD CONSTRAINT SlaesTable_SalesDetails FOREIGN KEY SlaesTable_SalesDetails (SalesDetails_SalesID)
